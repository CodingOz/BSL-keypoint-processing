...
def formalProcessingPipeline(start_corpus, show_logs=False):
    ...
    spatial_normaliser.normaliseCorpus(
        start_corpus + stage4, start_corpus + stage5)
